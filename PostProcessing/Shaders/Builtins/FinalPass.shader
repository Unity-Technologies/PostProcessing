    ...
    HLSLINCLUDE
        ...
        float4 Frag(VaryingsDefault i) : SV_Target
        {
            ...
            #if FXAA || FXAA_LOW
            {
                ...
                #if FXAA_KEEP_ALPHA
                {
                    color.a = SAMPLE_SCREENSPACE_TEXTURE(_MainTex, sampler_MainTex, i.texcoordStereo).a;
                }
                #endif
            }
            #else
            {
                color = SAMPLE_SCREENSPACE_TEXTURE(_MainTex, sampler_MainTex, i.texcoordStereo);
            }
            #endif
