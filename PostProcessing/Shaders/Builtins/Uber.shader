Shader "Hidden/PostProcessing/Uber"
{
    HLSLINCLUDE
        ...
        #include "Packages/com.pgac.postprocessing/PostProcessing/Shaders/Builtins/Distortion.hlsl"
        #include "Packages/com.pgac.postprocessing/PostProcessing/Shaders/Builtins/Dithering.hlsl"
